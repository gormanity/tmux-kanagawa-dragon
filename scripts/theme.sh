set_theme() {
  ...
  *)
  ...
  white=$text; gray=$bg_bar; dark_gray=$bg_pane
  light_purple=$highlight; dark_purple=$selection
  cyan=$info; green=$accent; orange=$notice
  red=$error; pink=$muted; yellow=$alert
}
