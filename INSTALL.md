...
set -g @kanagawa-dragon-cpu-usage-colors "muted bg_pane"
```
...
set -g @kanagawa-dragon-left-icon session
```
...
```
set -g @kanagawa-dragon-playerctl-format "►  {{ artist }} - {{ title }}"
```
